...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(PTC2_FAN_GPIO_Port, PTC2_FAN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PTC1_FAN2_Pin PTC2_FAN2_Pin */
  GPIO_InitStruct.Pin = PTC1_FAN2_Pin|PTC2_FAN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : S_ROTATION_Pin */
  GPIO_InitStruct.Pin = S_ROTATION_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(S_ROTATION_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : RED_LED_Pin PTC2_FAN_Pin */
  GPIO_InitStruct.Pin = RED_LED_Pin|PTC2_FAN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : TOP_REMOVED_Pin TOP_PRESENT_Pin LID_OPEN_Pin */
  GPIO_InitStruct.Pin = TOP_REMOVED_Pin|TOP_PRESENT_Pin|LID_OPEN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : FAN_PWM_Pin FAN_RPM_Pin */
  GPIO_InitStruct.Pin = FAN_PWM_Pin|FAN_RPM_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : PRESENT_CHM1_Pin PRESENT_CHM2_Pin PRESENT_TANK_Pin */
  GPIO_InitStruct.Pin = PRESENT_CHM1_Pin|PRESENT_CHM2_Pin|PRESENT_TANK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : ON_CHM1_MOT_Pin DIR_CHM1_MOT_Pin ON_CHM2_MOT_Pin DIR_CHM2_MOT_Pin
                           BREAK_ON_Pin */
  GPIO_InitStruct.Pin = ON_CHM1_MOT_Pin|DIR_CHM1_MOT_Pin|ON_CHM2_MOT_Pin|DIR_CHM2_MOT_Pin
                          |BREAK_ON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : AC_MAIN_Pin AC_MOTOR_Pin */
  GPIO_InitStruct.Pin = AC_MAIN_Pin|AC_MOTOR_Pin;
