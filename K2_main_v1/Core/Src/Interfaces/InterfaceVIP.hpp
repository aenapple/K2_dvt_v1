...
#define IFC_VIP_SENSOR_STATE_INDEX  (IFC_VIP_SUB_STATE_INDEX + 1)     // 1 byte
#define IFC_VIP_DAM_SHUTTER_INDEX   (IFC_VIP_SENSOR_STATE_INDEX + 1)  // 1 byte
#define IFC_VIP_MOTOR_STATE_INDEX   (IFC_VIP_DAM_SHUTTER_INDEX + 1)   // 1 byte
