...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, ON_BACK_LAMP_Pin|ON_FRONT_LAMP_Pin|PROG3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, RESET3_Pin|PROG2_Pin|RESET2_Pin|PROG1_Pin
  ...
  /*Configure GPIO pins : FAN_RPM_Pin IN_BACK_LAMP_Pin IN_FRONT_LAMP_Pin */
  GPIO_InitStruct.Pin = FAN_RPM_Pin|IN_BACK_LAMP_Pin|IN_FRONT_LAMP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : LOCK_LEFT_Pin LOCK_RIGHT_Pin */
  GPIO_InitStruct.Pin = LOCK_LEFT_Pin|LOCK_RIGHT_Pin;
  ...
  /*Configure GPIO pins : DAM_RIGHT_Pin DAM_LEFT_Pin INT1_Pin */
  GPIO_InitStruct.Pin = DAM_RIGHT_Pin|DAM_LEFT_Pin|INT1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
